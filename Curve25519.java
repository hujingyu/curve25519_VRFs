...
public class Curve25519 {
  ...
  public static Curve25519 getInstance(String type) throws org.whispersystems.curve25519.NoSuchProviderException {
    return getInstance(type, null);
  }

  public static Curve25519 getInstance(String type, org.whispersystems.curve25519.SecureRandomProvider random)
      throws org.whispersystems.curve25519.NoSuchProviderException
  {
    ...
    else                          throw new org.whispersystems.curve25519.NoSuchProviderException(type);
  }

  private final org.whispersystems.curve25519.Curve25519Provider provider;

  private Curve25519(org.whispersystems.curve25519.Curve25519Provider provider) {
   ...
   */
  public org.whispersystems.curve25519.Curve25519KeyPair generateKeyPair() {
    byte[] privateKey = provider.generatePrivateKey();
    byte[] publicKey  = provider.generatePublicKey(privateKey);

    return new org.whispersystems.curve25519.Curve25519KeyPair(publicKey, privateKey);
  }
